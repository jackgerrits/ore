...
struct light_component : public base_component<light_component> {
    glm::vec4 position;  // Position of the camera in world coordinates. w value
                         // of 0 indicates directional light, 1 indicates
    ...
    virtual std::string get_type() const { return "light"; }
};
}  // namespace ore
