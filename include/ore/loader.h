...
class loader {
   private:
    ...
    GLuint load_texture_data(GLubyte* data, int x, int y, int n,
                             GLenum textureUnit);
    GLuint setup_buffer(unsigned int buffer, std::vector<float> values,
                        int attributeIndex, int dataDimension);
    GLuint setup_indices_buffer(unsigned int buffer,
   ...
   public:
    ...
    model_part load_model_part(tinyobj::shape_t,
                               std::vector<tinyobj::material_t> materials,
                               std::string materialpath);
    model_part load_model_part(std::vector<float> vertices,
                               std::vector<unsigned int> indices,
    ...
    GLuint load_vao(std::vector<float> vertices,
                    std::vector<unsigned int> indices);
    GLuint load_vao(std::vector<float> vertices,
                    std::vector<unsigned int> indices,
                    std::vector<float> texCoords);
    GLuint load_vao(std::vector<float> vertices,
                    std::vector<unsigned int> indices,
                    std::vector<float> texCoords, std::vector<float> normals);
