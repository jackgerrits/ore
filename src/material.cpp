...
material::material(tinyobj::material_t material) {
    name = material.name;
    std::copy(std::begin(material.ambient), std::end(material.ambient),
              ambient.begin());
    std::copy(std::begin(material.diffuse), std::end(material.diffuse),
              diffuse.begin());
    std::copy(std::begin(material.specular), std::end(material.specular),
              specular.begin());
    std::copy(std::begin(material.transmittance),
              std::end(material.transmittance), transmittance.begin());
    std::copy(std::begin(material.emission), std::end(material.emission),
              emission.begin());
