...
void entity_shader::load_model_part(const model_part& component) {
    ...
    load_uniform_value(location_mtl_ambient,
                       component.get_material().ambient.data(), 3);
    load_uniform_value(location_mtl_diffuse,
                       component.get_material().diffuse.data(), 3);
    load_uniform_value(location_mtl_specular,
                       component.get_material().specular.data(), 3);
    load_uniform_value(location_emission,
                       component.get_material().emission.data(), 3);
